...
const Biberon = () => {
  ...
  const fetchBiberons = async () => {
    setLoading(true);
    try {
      const res = await axios.get(`https://application-de-suivi-medical-et-de-sante.onrender.com/api/biberons/baby/${babyId}/`);
  ...
  const handleSave = async () => {
    ...
    try {
      if (editing) {
        await axios.put(`https://application-de-suivi-medical-et-de-sante.onrender.com/api/biberons/${editing.id}/`, payload);
      } else {
        await axios.post('https://application-de-suivi-medical-et-de-sante.onrender.com/api/biberons/', payload);
      }
  ...
  const handleDelete = async (id: number) => {
    Alert.alert('Confirmation', 'Supprimer ce biberon ?', [
      { text: 'Annuler', style: 'cancel' },
      {
        ...
        onPress: async () => {
          try {
            await axios.delete(`https://application-de-suivi-medical-et-de-sante.onrender.com/api/biberons/${id}/delete/`);
            fetchBiberons();
          } catch (e) {
