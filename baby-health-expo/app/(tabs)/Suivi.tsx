  ...
  useEffect(() => {
    const fetchParentData = async () => {
      try {
        ...
        const parentResponse = await axios.get(`http://192.168.57.8:8000/api/parent/${parentId}/`);
        setParent(parentResponse.data);

        const babysResponse = await axios.get(`http://192.168.57.8:8000/api/user/get_babies_by_parent_id/${parentId}/`);
