...
const CouchePage = () => {
  ...
  const fetchCouches = async () => {
    setLoading(true);
    try {
      const res = await axios.get(`https://application-de-suivi-medical-et-de-sante.onrender.com/api/couches/baby/${babyId}/`);
  ...
  const handleSave = async () => {
    ...
    try {
      if (editing) {
        await axios.post(`https://application-de-suivi-medical-et-de-sante.onrender.com/api/couches/${editing.id}/`, payload);
      } else {
        await axios.post(`https://application-de-suivi-medical-et-de-sante.onrender.com/api/couches/`, payload);
      }
    ...
    Alert.alert('Confirmation', 'Supprimer cette couche ?', [
      { text: 'Annuler', style: 'cancel' },
      {
        text: 'Supprimer', style: 'destructive', onPress: async () => {
          try {
            await axios.delete(`https://application-de-suivi-medical-et-de-sante.onrender.com/api/couches/${id}/delete/`);
            fetchCouches();
          } catch (e) {
