...
export default function LoginForm() {
  ...
  const handleLogin = () => {
    ...
    axios
      .post('http://192.168.1.107:8000/api/user/login_parent/', userData)
      .then(async (response) => {
        ...
        const babyResponse = await axios.get(`http://192.168.1.107:8000/api/user/get_babies_by_parent_id/${parentId}/`);
